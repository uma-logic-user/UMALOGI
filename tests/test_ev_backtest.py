...
def sample_df() -> pd.DataFrame:
    ...
    return pd.DataFrame({
        ...
        "model_type":      np.where(rng.integers(0, 2, n) == 0, "HonmeiModel", "ManjiModel"),
        "bet_type":        "win",
...
class TestGridSearch:
    ...
    def test_required_columns_present(self, sample_df: pd.DataFrame) -> None:
        ...
        required = {
            ...
            "hit_rate", "roi", "sharpe_ratio", "max_drawdown",
        }
    ...
    def test_empty_df_returns_empty(self) -> None:
        empty = pd.DataFrame(columns=[
            "race_date", "expected_value", "win_odds",
            "is_hit", "payout", "recommended_bet",
        ])
